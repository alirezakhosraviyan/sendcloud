...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['feed_id'], ['feeds.pk'], ),
    sa.PrimaryKeyConstraint('pk'),
    sa.UniqueConstraint('link')
    )
