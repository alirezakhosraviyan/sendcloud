...
Revision ID: e5b313ec6123
Revises:
Create Date: 2023-06-03 19:38:06.242159
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("copyright_text", sa.VARCHAR(length=1024), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("title", sa.VARCHAR(length=255), nullable=False),
        sa.Column("description", sa.VARCHAR(length=1024), nullable=False),
        sa.Column("author", sa.VARCHAR(length=1024), nullable=False),
